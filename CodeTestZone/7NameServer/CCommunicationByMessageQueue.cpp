...
#include "CCommunicationByMessageQueue.h"

CCommunicationByMessageQueue:: CCommunicationByMessageQueue(CMessageQueueByUserDefined * pMsgQueue)
{
	if(0 == pMsgQueue)
	{
...
CCommunicationByMessageQueue:: ~CCommunicationByMessageQueue()
{

}
CStatus CCommunicationByMessageQueue:: PostMessage(CMessage * pMsg)
{
	if(0 == pMsg)
	{
