 ...
 * =====================================================================================
 */
CMsgLoopMgrForUserDefinedQueue::CMsgLoopMgrForUserDefinedQueue(CMessageQueueByUserDefined * pQueue,CMessageObserver *pMsgObserver):CMessageLoopManager(pMsgObserver)
{
 	if(NULL == pQueue)
	{
