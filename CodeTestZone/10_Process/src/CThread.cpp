...
CThread::CThread(IUsrBizForExecObj * pUsrBizForExecObj):CExecutiveObject(pUsrBizForExecObj)
{
	m_pContext = 0;
...
CThread::CThread(IUsrBizForExecObj * pUsrBizForExecObj,bool bWaitForDeath):CExecutiveObject(pUsrBizForExecObj)
{
	m_pContext = 0;
