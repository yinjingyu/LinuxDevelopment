...
typedef CStatus (CMessageObserver:: *CallBackFunctionOfMsgObserver)(CMessage *);
...
class CMessageLoopManager
{
	...
	//在消息循环的构造函数中，初始化观察者
	CMessageLoopManagerManager(CMessageObserver * pMsgObserver);
	...
	//来通知观察者
	CMessageObserver * m_pMsgObserver;
	//消息-函数 映射表
