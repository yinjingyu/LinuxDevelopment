 ...
 * =====================================================================================
 */
CStatus CMessageLoopManager::Register(unsigned int iMsgTypeID, CMessageObserver * pMsgObserver)
{
	if(0 == pMsgObserver)
	{
	...
	m_MsgFuncMappingTable[iMsgTypeID] = pMsgObserver;
	return CStatus(0,0);
}
